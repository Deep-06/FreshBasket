...
export const AboutUs = () => {
    return (
        <DIV>
            <button class="button-54" ><span class="text">Our Mission</span></button><br /><br />
            <p className='main-p'>
            ...
            <div className='div-flex'>
                <div className='fifty'>
                    <br /><br /><br />
                    <button class="button-54" ><span class="text">About FreshBasket</span></button><br /><br />
            ...
            <button class="button-54" ><span class="text">Our Team</span></button><br /><br />
            ...
            <br /><br />
            <button class="button-54" ><span class="text">FreshBasket in News</span></button><br /><br />
            <div className='team'>
                <div>
